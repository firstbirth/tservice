<template>
	<svg width="0" height="0" class="hidden">
		<symbol xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" id="ui-checks">
			<path
		...
		<symbol xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" id="layout-text-sidebar-reverse">
			<path
		...
		<symbol xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" id="calendar-week">
			<path
		...
		<symbol xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" id="three-dots">
			<path
...
<style scoped>/* Дополнительные стили для компонента */</style>