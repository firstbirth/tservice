                ...
                <ion-card-content class="ion-no-padding">
                    <ion-list :inset="false">
                        ...
                        <ion-item :button="true" :detail="false">
                            <ion-label>
                                <h2>Дата</h2>
                                <p>{{ formatDateToLocaleString(clientOrder?.date) }}</p>
                            </ion-label>
                        </ion-item>
                        <ion-item :button="true" :detail="false">
                            <ion-label>
                                <h2>Клиент</h2>
                                <p>{{ clientOrder?.client }}</p>
                            </ion-label>
                        </ion-item>
                        <ion-item :button="true" :detail="false">
                            <ion-label>
                                <h2>Сумма</h2>
                                <p>{{ clientOrder?.totalSum }} тг.</p>
                            </ion-label>
                        </ion-item>
                        <ion-item :button="true" :detail="false">
                            <ion-label>
                                <h2>Процент выполнения</h2>
                                <p>{{ clientOrder?.fulfillment }} %</p>
                            </ion-label>
                        </ion-item>
                        <ion-item :button="true" :detail="false">
                            <ion-label>
                                <h2>Комментарий</h2>
                                <p>{{ clientOrder?.comment ? clientOrder?.comment : "Не указан"  }}</p>
                            </ion-label>
                        </ion-item>
                        <ion-item :button="true" :detail="false">
                            <ion-label>
                                <h2>Автор</h2>
                                <p>{{ clientOrder?.author ? clientOrder?.author : "Не указан" }}</p>
                            </ion-label>
                        </ion-item>
                    </ion-list>
                </ion-card-content>
...
const fetchTaskData = async (orderOID: string) => {
    ...
    try {
        task_data = await ClientOrderService.getClientOrderByOID(1,orderOID);
    } catch (error) {
